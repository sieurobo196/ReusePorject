 ...
 */
public final class CustomMatrixToImageConfig {
   ...
   */
  public CustomMatrixToImageConfig() {
    this(BLACK, WHITE);
  }
   ...
   */
  public CustomMatrixToImageConfig(int onColor, int offColor) {
  ...
  public int getCustomBufferedImageColorModel() {
	    // Use faster BINARY if colors match default
	    return onColor == BLACK && offColor == WHITE ? BufferedImage.TYPE_BYTE_BINARY : BufferedImage.TYPE_INT_RGB;
	  }
